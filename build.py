...
CORE = ['build_info.js',
        ...
        'konfigurace.js', 'sablony_online.js', 'analytika.js', 'nastaveni_db.js', 'program.js', 'ukazkove.js', 'prava.js', 'zobrazeni.js', 'zakaznici.js', 'standard_ock.js', 'testdata.js']

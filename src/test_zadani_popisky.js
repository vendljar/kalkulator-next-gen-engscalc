 ...
 *
 * Od 24. 9. 2026 (T4) se vykreslené popisky a detail výpočtu ověřují
 * v prohlížeči (overit_zadani_detail.mjs); tady zbyla funkce nulaOznac.
 */
const fs = require('fs');
...
/* ---------- 1), 2) a 4) PŘESUNUTY DO PROHLÍŽEČE (T4, 24. 9. 2026) ----------
 * Kontroly popisných odstavců v zadání, vysvětlení v detailu výpočtu
 * a prázdných buněk vysvětlení se dřív dělaly regulárními výrazy nad
 * zdrojákem. Nově je ověřuje overit_zadani_detail.mjs na vykreslené
 * stránce (revize v22.9.9, nález T4: test má hlídat, co člověk vidí,
 * ne tvar kódu). Tady zůstává jen čistá funkce nulaOznac. */

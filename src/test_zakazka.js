...
/* ---- jedinečné id variant (bezpečnostní audit 9. 9. 2026, B29) ---- */
{
  const z = zk.novaZakazka();
  const v0 = z.varianty[0];
  test('zakazkaUnikatniId vrátí volné id beze změny', zk.zakazkaUnikatniId(z, 'v9') === 'v9');
  test('obsazené id dostane pořadovou příponu', zk.zakazkaUnikatniId(z, v0.id) === v0.id + '-1');
